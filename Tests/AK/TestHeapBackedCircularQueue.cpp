...
TEST_CASE(basic)
{
    HeapBackedCircularQueue<int> ints(3);
...
{
    HeapBackedCircularQueue<String> strings(2);
...
{
    HeapBackedCircularQueue<String> strings(5);
    strings.enqueue("xxx");
    strings.enqueue("xxx");
    strings.enqueue("xxx");
    strings.enqueue("xxx");
...
{
    HeapBackedCircularQueue<ConstructorCounter> queue(10);
